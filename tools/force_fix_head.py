...
head_content = r'''<meta charset="utf-8">
...
extend_head_content = r'''<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8651981255093232"
    crossorigin="anonymous"></script>
<meta name="google-site-verification" content="UxSUmYw5fQoQltif7fwnK8bHZYOFdKnvvo4_-xrXsM8" />
<!-- Leaflet.js - インタラクティブマップ -->
<link rel="stylesheet" href="{{ "css/leaflet.css" | absURL }}" />
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
    integrity="sha256-20nQCchB9co0qIjJZRGuk2/Z9VM+kNiyxNV1lvTlZBo=" crossorigin=""></script>

<!-- Google Analytics 4 (GA4) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-VKZ4FDSZWB"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'G-VKZ4FDSZWB');
</script>
'''

with open(r'website\layouts\partials\head.html', 'w', encoding='utf-8') as f:
    f.write(head_content)

with open(r'website\layouts\partials\extend_head.html', 'w', encoding='utf-8') as f:
    f.write(extend_head_content)

print("Files overwritten successfully via Python.")
