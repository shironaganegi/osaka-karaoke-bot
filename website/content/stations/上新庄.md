...
<div class="store-list-container">
        <div class="store-card">
            ...
            <div class="price-grid">
                <div class="price-item">
                    ...
                    <span class="price-value">210円〜</span>
                </div>
                <div class="price-item">
                    <span class="price-label">フリータイム (平日昼)</span>
                    <span class="price-value">1490円〜</span>
                </div>
            </div>
        ...
        <div class="store-card">
            ...
            <div class="price-grid">
                ...
                <div class="price-item">
                    <span class="price-label">フリータイム (平日昼)</span>
                    <span class="price-value">1510円〜</span>
                </div>
            </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.749395699999994, 135.5331362], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.7461577, 135.5208992], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ上新庄駅前店<br>30分: 210円');
      L.circleMarker([34.7526337, 135.5453732], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ上新庄ほんまに駅前店<br>30分: 230円');
  })();
</script>
