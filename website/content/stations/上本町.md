...
- 🏆 **平日昼フリータイム最安**: 1190円（ジャンカラ上本町駅前店）



| 店舗名 | 料金（平日昼） | 地図 |
| --- | --- | --- |
| [🎤 ジャンカラ ジャンカラ上本町駅前店](https://jankara.ne.jp/shop/021/) | 30分: 230円 (会員190円) / フリータイム: 1190円 (会員980円) | [📍 地図](https://www.google.com/maps/search/?api=1&query=34.6655807,135.5201501) |
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.6655807, 135.5201501], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.6655807, 135.5201501], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ上本町駅前店<br>30分: 230円');
  })();
</script>
