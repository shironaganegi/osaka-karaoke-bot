...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.77599565, 135.6267397], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.7661928, 135.6239033], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ寝屋川駅前店<br>30分: 230円');
      L.circleMarker([34.7857985, 135.6295761], {radius: 10, color: 'gold', fillColor: 'gold', fillOpacity: 0.7}).addTo(map).bindPopup('カラオケまねきねこ 香里園店');
  })();
</script>
