...
- 🏆 **平日昼30分最安**: 320円（ジャンカラ深井駅前店）
- 🏆 **平日昼フリータイム最安**: 1770円（ジャンカラ深井駅前店）
        ...
        <div class="store-card">
            ...
            <div class="price-grid">
                ...
                <div class="price-item">
                    ...
                    <span class="price-value">1770円〜</span>
                </div>
            </div>

            <div class="action-area">
                <a href="https://www.google.com/maps/search/?api=1&query=34.5293661,135.499088" target="_blank" rel="noopener" class="action-btn btn-map">📍 地図</a>
                <a href="https://jankara.ne.jp/shop/208/" target="_blank" rel="noopener" class="action-btn btn-reserve">🔗 予約・詳細</a>
            </div>
        </div>
        </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.5293661, 135.499088], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.5293661, 135.499088], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ深井駅前店<br>30分: 320円');
  })();
</script>
