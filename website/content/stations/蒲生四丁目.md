...
| 店舗名 | 料金（平日昼） | 地図 |
| --- | --- | --- |
| [🎤 ビッグエコー カラオケ ビッグエコー蒲生四丁目駅前店](https://big-echo.jp/shop_info/%E3%83%93%E3%83%83%E3%82%B0%E3%82%A8%E3%82%B3%E3%83%BC%E8%92%B2%E7%94%9F%E5%9B%9B%E4%B8%81%E7%9B%AE%E9%A7%85%E5%89%8D%E5%BA%97) | 30分: 250円 (会員170円) / フリータイム: 1380円 (会員1020円) | [📍 地図](https://www.google.com/maps/search/?api=1&query=34.7049861,135.5449261) |
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.7049861, 135.5449261], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.7049861, 135.5449261], {radius: 10, color: 'red', fillColor: 'red', fillOpacity: 0.7}).addTo(map).bindPopup('カラオケ ビッグエコー蒲生四丁目駅前店<br>30分: 250円');
  })();
</script>
