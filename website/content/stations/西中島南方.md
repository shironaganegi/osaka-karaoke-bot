        ...
        <div class="store-card">
            ...
            <div class="price-grid">
                ...
                <div class="price-item">
                    ...
                    <span class="price-value">1730円〜</span>
                </div>
            </div>

            <div class="action-area">
                <a href="https://www.google.com/maps/search/?api=1&query=34.7317457,135.4914837" target="_blank" rel="noopener" class="action-btn btn-map">📍 地図</a>
                <a href="https://jankara.ne.jp/shop/209/" target="_blank" rel="noopener" class="action-btn btn-reserve">🔗 予約・詳細</a>
            </div>
        </div>
        </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.7317457, 135.4914837], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.7317457, 135.4914837], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ西中島店<br>30分: 300円');
  })();
</script>
