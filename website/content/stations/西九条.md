...
- 🏆 **平日昼30分最安**: 230円（ジャンカラ西九条駅前店）
- 🏆 **平日昼フリータイム最安**: 1230円（ジャンカラ西九条駅前店）
        ...
        <div class="store-card">
            ...
            <div class="price-grid">
                ...
                <div class="price-item">
                    ...
                    <span class="price-value">1230円〜</span>
                </div>
            </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.6827246, 135.4658011], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.6827246, 135.4658011], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ西九条駅前店<br>30分: 230円');
  })();
</script>
