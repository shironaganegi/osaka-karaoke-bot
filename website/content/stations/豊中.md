...
<div class="store-list-container">
        <div class="store-card">
            ...
            <div class="action-area">
                <a href="https://www.google.com/maps/search/?api=1&query=34.582686,135.4862883" target="_blank" rel="noopener" class="action-btn btn-map">📍 地図</a>
                <a href="https://jankara.ne.jp/shop/014/" target="_blank" rel="noopener" class="action-btn btn-reserve">🔗 予約・詳細</a>
            </div>
        </div>
        </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.582686, 135.4862883], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.582686, 135.4862883], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ豊中駅前店<br>30分: 250円');
  })();
</script>
