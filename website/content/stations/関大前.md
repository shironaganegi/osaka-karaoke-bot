        ...
        <div class="store-card">
            ...
            <div class="price-grid">
                ...
                <div class="price-item">
                    ...
                    <span class="price-value">2150円〜</span>
                </div>
            </div>
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.7738429, 135.5077669], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.7738429, 135.5077669], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラオールナイト関大前店<br>30分: 290円');
  })();
</script>
