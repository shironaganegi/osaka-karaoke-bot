...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.849704, 135.61355613333333], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.8466754, 135.5973224], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ高槻2号店<br>30分: 240円');
      L.circleMarker([34.8509822, 135.6206819], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ高槻3号店<br>30分: 240円');
      L.circleMarker([34.8514544, 135.6226641], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ高槻シースー店<br>30分: 240円');
  })();
</script>
