...
| 店舗名 | 料金（平日昼） | 地図 |
| --- | --- | --- |
| [🎤 ジャンカラ ジャンカラ鶴橋駅前店](https://jankara.ne.jp/shop/010/) | 30分: 250円 (会員190円) / フリータイム: 990円 (会員680円) | [📍 地図](https://www.google.com/maps/search/?api=1&query=34.6670632,135.5333073) |
| [🐱 まねきねこ カラオケまねきねこ 鶴橋店](https://www.karaokemanekineko.jp/locations/osaka/osaka-shi/tsuruhashi-store/) | [公式サイトで確認](https://www.karaokemanekineko.jp/locations/osaka/osaka-shi/tsuruhashi-store/) | [📍 地図](https://www.google.com/maps/search/?api=1&query=34.6670632,135.5333073) |
...
<script>
  (function() {
    ...
    var map = L.map('map').setView([34.6670632, 135.5333073], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a>',
      maxZoom: 19
    }).addTo(map);
      L.circleMarker([34.6670632, 135.5333073], {radius: 10, color: 'blue', fillColor: 'blue', fillOpacity: 0.7}).addTo(map).bindPopup('ジャンカラ鶴橋駅前店<br>30分: 250円');
      L.circleMarker([34.6670632, 135.5333073], {radius: 10, color: 'gold', fillColor: 'gold', fillOpacity: 0.7}).addTo(map).bindPopup('カラオケまねきねこ 鶴橋店');
  })();
</script>
